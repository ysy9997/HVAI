...
# Attempt to import MLDecoder
try:
    from ML_Decoder.models.tresnet.layers.decoder import MLDecoder
except ImportError:
    MLDecoder = None
...
if __name__ == "__main__":
    ...
    # Data and Setup
    parser.add_argument('--vector_path', type=str, default='/home/haiqv/workspace/hvai/openclip_playground/ViT-SO400M-14-SigLIP2/feature_dict.pt', help='Path to the .pt file containing the feature dictionary.')
    parser.add_argument('--save_dir', type=str, default='runs/train/mlp', help='Directory to save training runs and model checkpoints.')
    parser.add_argument('--make', type=str, default='', help='If set, the task becomes model classification among the given make.')
    parser.add_argument('--classifier', type=str, default='mlp', choices=['linear', 'mlp', 'mldecoder'], help='Type of classification head to use.')
